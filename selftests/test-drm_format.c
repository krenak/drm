...
struct drm_selftest tests[] = {
	{
		.enabled = true,
		.name = "check_drm_format_block_height",
		.func = igt_check_drm_format_block_height,
	},
	{
		.enabled = true,
		.name = "check_drm_format_block_width",
		.func = igt_check_drm_format_block_width
	},
	{
		.enabled = true,
		.name = "check_drm_format_min_pitch",
		.func = igt_check_drm_format_min_pitch
	},
};
...
static int __init test_drm_format_init(void)
{
	int err;
...
static void __exit test_drm_format_exit(void)
{
}

module_init(test_drm_format_init);
module_exit(test_drm_format_exit);
