...
struct drm_selftest tests[] = {
       {
               .enabled = true,
               .name = "drm_rect_clip_scaled_div_by_zero",
               .func = igt_drm_rect_clip_scaled_div_by_zero,
       },
       {
               .enabled = true,
               .name = "drm_rect_clip_scaled_not_clipped",
               .func = igt_drm_rect_clip_scaled_not_clipped,
       },
       {
               .enabled = true,
               .name = "drm_rect_clip_scaled_clipped",
               .func = igt_drm_rect_clip_scaled_clipped,
       },
       {
               .enabled = true,
               .name = "drm_rect_clip_scaled_signed_vs_unsigned",
               .func = igt_drm_rect_clip_scaled_signed_vs_unsigned,
       },
};
...
static int __init test_drm_rect_init(void)
{
       int err;
...
static void __exit test_drm_rect_exit(void)
{
}

module_init(test_drm_rect_init);
module_exit(test_drm_rect_exit);
