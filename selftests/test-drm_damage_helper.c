...
struct drm_selftest tests[] = {
       {
               .enabled = true,
               .name = "damage_iter_no_damage",
               .func = igt_damage_iter_no_damage,
       },
       {
               .enabled = true,
               .name = "damage_iter_no_damage_fractional_src",
               .func = igt_damage_iter_no_damage_fractional_src,
       },
       {
               .enabled = true,
               .name = "damage_iter_no_damage_src_moved",
               .func = igt_damage_iter_no_damage_src_moved,
       },
       {
               .enabled = true,
               .name = "damage_iter_no_damage_fractional_src_moved",
               .func = igt_damage_iter_no_damage_fractional_src_moved,
       },
       {
               .enabled = true,
               .name = "damage_iter_no_damage_not_visible",
               .func = igt_damage_iter_no_damage_not_visible,
       },
       {
               .enabled = true,
               .name = "damage_iter_no_damage_no_crtc",
               .func = igt_damage_iter_no_damage_no_crtc,
       },
       {
               .enabled = true,
               .name = "damage_iter_no_damage_no_fb",
               .func = igt_damage_iter_no_damage_no_fb,
       },
       {
               .enabled = true,
               .name = "damage_iter_simple_damage",
               .func = igt_damage_iter_simple_damage,
       },
       {
               .enabled = true,
               .name = "damage_iter_single_damage",
               .func = igt_damage_iter_single_damage,
       },
       {
               .enabled = true,
               .name = "damage_iter_single_damage_intersect_src",
               .func = igt_damage_iter_single_damage_intersect_src,
       },
       {
               .enabled = true,
               .name = "damage_iter_single_damage_outside_src",
               .func = igt_damage_iter_single_damage_outside_src,
       },
       {
               .enabled = true,
               .name = "damage_iter_single_damage_fractional_src",
               .func = igt_damage_iter_single_damage_fractional_src,
       },
       {
               .enabled = true,
               .name = "damage_iter_single_damage_intersect_fractional_src",
               .func = igt_damage_iter_single_damage_intersect_fractional_src,
       },
       {
               .enabled = true,
               .name = "damage_iter_single_damage_outside_fractional_src",
               .func = igt_damage_iter_single_damage_outside_fractional_src,
       },
       {
               .enabled = true,
               .name = "damage_iter_single_damage_src_moved",
               .func = igt_damage_iter_single_damage_src_moved,
       },
       {
               .enabled = true,
               .name = "damage_iter_single_damage_fractional_src_moved",
               .func = igt_damage_iter_single_damage_fractional_src_moved,
       },
       {
               .enabled = true,
               .name = "damage_iter_damage",
               .func = igt_damage_iter_damage,
       },
       {
               .enabled = true,
               .name = "damage_iter_damage_one_intersect",
               .func = igt_damage_iter_damage_one_intersect,
       },
       {
               .enabled = true,
               .name = "damage_iter_damage_one_outside",
               .func = igt_damage_iter_damage_one_outside,
       },
       {
               .enabled = true,
               .name = "damage_iter_damage_src_moved",
               .func = igt_damage_iter_damage_src_moved,
       },
       {
               .enabled = true,
               .name = "damage_iter_damage_not_visible",
               .func = igt_damage_iter_damage_not_visible,
       }
};
...
static int __init test_drm_damage_init(void)
{
	int err;
...
static void __exit test_drm_damage_exit(void)
{
}

module_init(test_drm_damage_init);
module_exit(test_drm_damage_exit);
